###### 사용되지 않는 파일입니다. grid_view로 refactor했습니다.
        ...
        if customer_detail:
            ...
            food = [
                dogdog.dropdown_menu_option(
                    key=customer_food_id,
                    text=f"{detail.get('brand')} {detail.get('product_name')}",
                )
...
def status_update_menu(page: ft.Page, popup):
    ...
    content_list_top = [
        (
            "밥주기",
            "dogbowl.png",
            lambda e, call="feeding": bottom_sheet(e, page, popup, call),
        ),
        (
            "물주기",
            "waterdrop.png",
            lambda e, call="watering": bottom_sheet(e, page, popup, call),
        ),
        (
            "활동기록",
            "dogwalking.png",
            lambda e, call="daily_walks": bottom_sheet(e, page, popup, call),
        ),
    ]
    content_list_bottom = [
        (
            "배변",
            "poop.png",
            lambda e, call="hygiene_bowel": bottom_sheet(e, page, popup, call),
        ),
        (
            "건강기록",
            "injection.png",
            lambda e, call="health_log": bottom_sheet(e, page, popup, call),
        ),
        (
            "상태기록",
            "note.png",
            lambda e, call="status_log": bottom_sheet(e, page, popup, call),
        ),
    ]
    # ---------------------------------------------------------------------------------------------------
    content_column = [
