    ...
    async def on_food_search_change(self, e):
        ...
        self.food_list_column.controls.append(
            ft.Row(
                ...
                controls=[ft.ProgressRing(width=20, height=20, stroke_width=2), ft.Text("검색 중...", size=12)]
            )
        )
        self.page.update()
        ...
        try:
            ...
            res_data = res.json().get("data", []) if res.status_code == 200 else []
            # Transform to [product_detail_id, "product_name"]
