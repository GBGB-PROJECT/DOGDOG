...
import json
import numpy as np
from backend.app.ai.recommend import calculate_base_g

model = joblib.load("dogdog_app_api_py/backend/app/ai/recommend/models/model.pkl")

with open("dogdog_app_api_py/backend/app/ai/recommend/models/feature_columns.json", "r") as f:
