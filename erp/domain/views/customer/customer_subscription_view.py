        ...
        rows.append(
            {
                ...
                "subscription_product": row.get("subscription_product", row.get("subscription_product", "")),
                "subscription_products": row.get("subscription_product", row.get("subscription_product", "")),
                "item_quantity": row.get("item_quantity", row.get("item_quantity", "")),
                "total_quantity": row.get("item_quantity", row.get("item_quantity", "")),
                "item_final_amount": format_money_text(row.get("item_final_amount", row.get("item_final_amount", ""))),
                "total_final_amount": format_money_text(row.get("item_final_amount", row.get("item_final_amount", ""))),
...
def erp_customer_subscription_view():
    ...
    class CustomerSubscriptionPage(ft.Container):
        def did_mount(self):
            self.page.run_thread(lambda: (reload_current_page(), self.page.update()))

    return CustomerSubscriptionPage(expand=True, content=page_layout)
