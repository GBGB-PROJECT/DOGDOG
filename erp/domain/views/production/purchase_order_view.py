...
def erp_purchase_order_view():
    ...
    columns = [
        ...
        {"key": "is_purchase_order_cancel", "label": "취소여부", "width": 90, "align_x": 0},
                ...
                controls=[
                    *[
                        build_table_cell(
                            ...
                            col["width"],
                            col["align_x"],
                            ft.FontWeight.W_700 if col["key"] in ["pay_status", "is_purchase_order_cancel"] else ft.FontWeight.W_400,
                            status_color if col["key"] == "pay_status" else cancel_color if col["key"] == "is_purchase_order_cancel" else TEXT_ROW,
                        )
                        for col in columns
                    ],
                    ft.Container(
